...
def send_message(
    ...
    async def broadcast_updates(msg_json, sess_id):
    ...
    background_tasks.add_task(broadcast_updates, user_msg_json, session_id)
    ...
    background_tasks.add_task(broadcast_updates, ai_msg_json, session_id)
